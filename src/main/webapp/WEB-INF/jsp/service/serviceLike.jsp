				...
				<form>
					<div class="modal-body">
						<div class="form-group">
							<label>服务类型:</label> <select name="city" id=""
								class="form-control">
						...
						<div class="form-group">
							<label>概要:</label> <input type="text" name="msName"
								class="form-control">
						</div>
						<div class="form-group">
							<label>客户名称:</label> <input type="text" name="msName"
								class="form-control">
						</div>
						<div class="form-group">
							<label>状态:</label> <select name="city" id="" class="form-control">
						...
						<div class="form-group">
							<label>处理人:</label> <input type="text" name="msName"
								class="form-control">
						</div>
						<div class="form-group">
							<label>服务请求:</label> <input type="textarea" name="msName"
								style="height: 60px" class="form-control">
						</div>
						<div class="form-group">
							<label>服务处理过程:</label> <input type="textarea" name="msName"
								style="height: 60px" class="form-control">
						</div>
					</div>
				</form>
